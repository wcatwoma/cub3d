...
int mlx_shaders_pixel(glsl_info_t *glsl)
{
  ...
  if (!action_ok) {
    printf(stderr, "Failed to compile pixel vshader :\n");
  ...
  if (!action_ok) {
    printf(stderr, "Failed to compile pixel fshader :\n");
  ...
  if (!action_ok) {
    printf(stderr, "Failed to link pixel shader program:\n");
...
int mlx_shaders_image(glsl_info_t *glsl)
{
  ...
  if (!action_ok) {
    printf(stderr, "Failed to compile image vshader :\n");
  ...
  if (!action_ok) {
    printf(stderr, "Failed to compile image fshader :\n");
  ...
  if (!action_ok) {
    printf(stderr, "Failed to link image shader program:\n");
...
int mlx_shaders_font(glsl_info_t *glsl)
{
  ...
  if (!action_ok) {
    printf(stderr, "Failed to compile font vshader :\n");
  ...
  if (!action_ok) {
    printf(stderr, "Failed to compile font fshader :\n");
  ...
  if (!action_ok) {
    printf(stderr, "Failed to link font shader program:\n");
